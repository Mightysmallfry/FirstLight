...
namespace FirstLightMod.Modules.Equipment
{
    class ExampleEquipWithTargeting : EquipmentBase<ExampleEquipWithTargeting>
    {
        ...
        private void CreateTargetingIndicator()
        {
            ...
            TargetingIndicatorPrefabBase.GetComponentInChildren<SpriteRenderer>().sprite = Addressables.LoadAssetAsync<Sprite>("RoR2/Base/Common/MiscIcons/texMysteryIcon.png").WaitForCompletion(); 
