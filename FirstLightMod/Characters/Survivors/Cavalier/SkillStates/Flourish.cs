...
namespace FirstLightMod.Survivors.Cavalier.SkillStates
{
    ...
    {
        public static float buffDuration = 3.0f;
        ...
        public override void OnEnter()
        {
            ...
            {
                characterBody.AddTimedBuff(RoR2Content.Buffs.HiddenInvincibility, 0.5f * duration); //So you're invincible while dodging
            }
        }
        ...
        public override void OnExit()
        {
            ...
            characterBody.AddTimedBuff(CavalierBuffs.stylishBuff, buffDuration); //So you're invincible while dodging
        }
