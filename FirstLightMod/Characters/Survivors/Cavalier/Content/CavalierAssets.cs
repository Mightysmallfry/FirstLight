...
{
    public static class CavalierAssets
    {
        // particle effects
        ...
        public static void Init(AssetBundle assetBundle)
        {
            ...
            swordHitSoundEvent = Modules.Content.CreateAndAddNetworkSoundEventDef("FarmerSwordHit");
        ...
        private static void CreateBombProjectile()
        {
            ...
            bombImpactExplosion.lifetimeExpiredSound = Modules.Content.CreateAndAddNetworkSoundEventDef("FarmerBombExplosion");
