...
namespace FirstLightMod.Survivors.Farmer.SkillStates
{
    ...
    {
        public static float damageCoefficient = FarmerStaticValues.cannonDamageCoefficient;
        public static float explosionRadius = FarmerStaticValues.cannonExplosionRadius;
            ...
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    ...
                    new BulletAttack
                    {
                        ...
                        //hitEffectPrefab = EntityStates.Huntress.HuntressWeapon.FireArrow.hitEffectPrefab,
                    }.Fire();
                }
            }
        }
