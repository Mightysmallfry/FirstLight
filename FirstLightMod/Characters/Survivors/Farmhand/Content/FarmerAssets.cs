...
{
    public static class FarmerAssets
    {
        // particle effects
        ...
        public static GameObject mortarEndpointVisualizerPrefab;
        ...
        private static void CreateProjectiles()
        {
            ...
            //Content.AddProjectilePrefab(mortarProjectilePrefab);
        }

        private static void CreateBombProjectile()
        {
            //highly recommend setting up projectiles in editor, but this is a quick and dirty way to prototype if you want
            bombProjectilePrefab = FirstLightAssets.CloneProjectilePrefab("CommandoGrenadeProjectile", "HenryBombProjectile");
        ...
        private static void CreateMortarProjectile()
        {
            //EntityStates.Treebot.Weapon.AimMortar2 mortar = new EntityStates.Treebot.Weapon.AimMortar2();
            //mortarProjectilePrefab = mortar.projectilePrefab;
