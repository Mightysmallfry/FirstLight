...
{
    internal static class FirstLightAssets
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            try
            {
                assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(FirstLightPlugin.instance.Info.Location), "AssetBundles", bundleName));
            }
        ...
        internal static GameObject CreateProjectileGhostPrefab(this AssetBundle assetBundle, string ghostName)
        {
            ...
            Modules.FirstLightAssets.ConvertAllRenderersToHopooShader(ghostPrefab);
